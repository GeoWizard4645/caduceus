    ...
    <>
      ...
      >
        <Toggle
          ...
          hint="The microphone only opens while you are holding the key, and closes the moment you let go."
        ...
        <div className="mt-4 grid grid-cols-2 gap-5">
          <Field
            ...
            hint="A bare Fn key cannot be captured — macOS handles it in firmware and it never reaches an app. F13–F20 make good single-key bindings if your keyboard has them."
          >
            <HotkeyInput
